...
## rqt_ez_publisher (lunar) - 0.4.0-0

The packages in the `rqt_ez_publisher` repository were released into the `lunar` distro by running `/usr/bin/bloom-release rqt_ez_publisher --track lunar --rosdistro lunar --new-track` on `Sat, 06 May 2017 05:00:13 -0000`
...
## rqt_ez_publisher (jade) - 0.3.0-1

The packages in the `rqt_ez_publisher` repository were released into the `jade` distro by running `/usr/bin/bloom-release rqt_ez_publisher --track jade --rosdistro jade` on `Mon, 11 Apr 2016 14:58:41 -0000`
...
## rqt_ez_publisher (indigo) - 0.3.1-1

The packages in the `rqt_ez_publisher` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rqt_ez_publisher --track indigo --rosdistro indigo` on `Mon, 11 Apr 2016 14:54:09 -0000`
...
## rqt_ez_publisher (indigo) - 0.3.1-0

The packages in the `rqt_ez_publisher` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rqt_ez_publisher --track indigo --rosdistro indigo` on `Mon, 11 Apr 2016 14:30:07 -0000`
...
## rqt_ez_publisher (jade) - 0.3.0-0

The packages in the `rqt_ez_publisher` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade rqt_ez_publisher` on `Sat, 02 May 2015 06:08:25 -0000`
...
## rqt_ez_publisher (hydro) - 0.2.0-1

The packages in the `rqt_ez_publisher` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro rqt_ez_publisher` on `Mon, 25 Aug 2014 14:28:39 -0000`
...
## rqt_ez_publisher (indigo) - 0.2.0-0

The packages in the `rqt_ez_publisher` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo rqt_ez_publisher` on `Sat, 19 Jul 2014 14:50:01 -0000`
